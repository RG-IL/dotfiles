...
-- Ueberzugpp
hl.window_rule({ match = { class = "org.caelestia.menu.terminal" }, float = true, size = "875 600", center = true })
hl.window_rule({ match = { class = "org.caelestia.about" }, float = true, size = "1000 500", center = true })
