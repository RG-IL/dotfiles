...
const vec4 TRAIL_COLOR = vec4(0.35, 0.75, 0.85, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.1, 0.2, 0.6, 1.0);
const float DURATION = 0.2; //IN SECOND
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    //cursorblaze
    trail = mix(TRAIL_COLOR_ACCENT, trail, 1. - smoothstep(0., sdfCurrentCursor + .000000002, 0.0000004));
    trail = mix(TRAIL_COLOR, trail, 1. - smoothstep(0., sdfCurrentCursor + .002, 0.0000000004));
    fragColor = mix(trail, fragColor, 1.0 - smoothstep(0., sdfCurrentCursor, easedProgress * lineLength));
}
