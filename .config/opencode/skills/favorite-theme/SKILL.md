...
name: favorite-theme
description: >-
  Use EVERY time the user configures a TUI, CLI tool, code editor, terminal,
  prompt, UI framework, component library, or any visual/graphical element.
  This is the user's single universal theme across their entire dotfiles stack.
---
