...
description: Log learnings, errors, and feature requests to .learnings/ markdown files for continuous improvement. Use when the user corrects you, a command fails, the user requests a missing feature, an API/tool fails, knowledge is outdated, or a better approach is discovered. Do NOT use for normal development tasks.
---
